...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Caching"
COPYRIGHT = 'Copyright 2012 The Fubu Team. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Caching.sln', :clrversion => CLR_TOOLS_VERSION
end
...
task :unit_test => :compile do
  ...
  runner.executeTests ['FubuMVC.Caching.Tests']
end

desc "ZIPs up the build results"
zip :package do |zip|
	zip.directories_to_zip = [props[:stage]]
	zip.output_file = 'FubuMVC.Caching.zip'
